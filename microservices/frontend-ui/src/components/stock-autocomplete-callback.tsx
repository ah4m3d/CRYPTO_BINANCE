...
interface StockAutocompleteWithCallbackProps {
  onStockSelect: (stock: { symbol: string; name: string }) => void
  placeholder?: string
  className?: string
  disabled?: boolean
}

export function StockAutocompleteWithCallback({ 
  onStockSelect, 
  placeholder = "Search stocks...", 
  className,
  disabled = false 
}: StockAutocompleteWithCallbackProps) {
